...
export const DataCollectionForm = () => {
  ...
  const loadExistingCollections = () => {
    const key = `scope4_data_collections_${template.id}_${selectedMonth}_${selectedYear}`;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              {template.sourceDescription} - {template.avoidedEmissionType}
            </p>
          </div>
        </div>
            ...
            <Card key={entry.id}>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  <p className="text-sm font-medium">Calculated Avoided Emissions</p>
      ...
      <Card className="bg-primary/5">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm text-muted-foreground">Total Avoided Emissions for Period</p>
              <p className="text-3xl font-bold text-green-600">-{totalEmissions.toFixed(2)} kg CO₂e</p>
            </div>
