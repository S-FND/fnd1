...
const _allMockCompanies: Company[] = [
  ...
  },
  {
    ...
    investmentStatus: 'Invested',
    fl: 'Dr. Renita Rajan',
    esgConnect: parseContact('Dr. Renita Rajan <drrajan@chosenstore.in>'),
    founder: parseContact('Dr. Renita Rajan <drrajan@chosenstore.in>'),
    industry: 'Beauty & Personal Care',
    revenueStage: '0-50',
    contactEmail: 'drrajan@chosenstore.in',
    loginPassword: generateUniquePassword('CHOSEN', 1),
    createdAt: '2020-01-01',
  },
  {
    id: 'company-223',
    ...
    investmentStatus: 'Invested',
    fl: 'Yatish Talvadia',
    esgConnect: parseContact('Yatish Talvadia <yatish@anmasa.com>'),
    founder: parseContact('Yatish Talvadia <yatish@anmasa.com>'),
    industry: 'Food & Beverage',
    revenueStage: '0-50',
    contactEmail: 'yatish@anmasa.com',
    loginPassword: generateUniquePassword('ANMASA', 1),
    createdAt: '2020-01-01',
  },
  {
    id: 'company-224',
    ...
    investmentStatus: 'Invested',
    fl: 'Manas Tripathi',
    esgConnect: parseContact('Manas Tripathi <manas@promom.in>'),
    founder: parseContact('Manas Tripathi <manas@promom.in>'),
    industry: 'Health & Wellness',
    revenueStage: '100-500',
    contactEmail: 'manas@promom.in',
    loginPassword: generateUniquePassword('PROMOM', 1),
    createdAt: '2020-01-01',
  },
  // Demo Company - NOT a real portfolio company (for demo/testing purposes only)
  {
